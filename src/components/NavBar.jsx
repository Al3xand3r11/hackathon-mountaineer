...
<nav class="bg-black  fixed w-full z-20 top-0 start-0  ">
  ...
  <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
      <FaBars color='white'/>
      <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Pluto</span>
  </a>
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
      <li className='flex'>
        ...
        <a href="#" class="block py-2 px-3 text-white rounded " aria-current="page">Live TV</a>
      </li>
      <li className='flex'>
        <img src={Play} alt="Play" className="5-8 h-8 pt-2"/>
        <a href="#" class="block py-2 px-3 text-white ">On Demand</a>
      </li>
      <li className='flex'>
        <img src={Search} alt="Search" className="5-8 h-8 pt-2"/>
        <a href="#" class="block py-2 px-3 text-white  ">Search</a>
      </li>
    </ul>
  </div>
  </div>
